        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('amelias.update', $amelias->id) }}" method="POST"
...
@error('title') is-invalid @enderror"
                                    name="title" value="{{ old('title', $amelias->title) }}"
...
@error('content') is-invalid @enderror" name="content" rows="5"
                                    placeholder="Masukkan Konten Post">{{ old('content', $amelias->content) }}</textarea>
